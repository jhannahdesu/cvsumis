                ...
                <article class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <div class="d-flex">
                                <select id="foreign-filter-type" class="form-select ms-2 me-1">
                                ...
                                <select id="foreign-filter-year" style="display:none;" class="form-select me-1"></select>
                                <select id="foreign-filter-value" style="display:none;" class="form-select me-1"></select>
                            </div>
                            ...
                            <div class="ms-auto d-flex">
                                ...
                                @endif
                                <button type="button" id="foreign-download-csv" class="btn btn-outline-info">
