        ...
        @if(Auth::user()->position != 4)
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingNatureAppointment">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseNatureAppointment" aria-expanded="false" aria-controls="collapseNatureAppointment">
                        Faculty profile by nature of appointment
                    </button>
                </h2>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingAcademicRank">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAcademicRank" aria-expanded="false" aria-controls="collapseAcademicRank">
                        Faculty profile by academic rank
                    </button>
                </h2>
        ...
        @endif
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingFacultyScholars">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFacultyScholars" aria-expanded="false" aria-controls="collapseFacultyScholars">
                        Faculty scholars
                    </button>
                </h2>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingGraduateStudies">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseGraduateStudies" aria-expanded="false" aria-controls="collapseGraduateStudies">
                        Graduated Studies
                    </button>
                </h2>
            ...
            <h2 class="accordion-header" id="headingRecognition">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseRecognition" aria-expanded="false" aria-controls="collapseRecognition">
            ...
            <h2 class="accordion-header" id="headingPresentations">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePresentations" aria-expanded="false" aria-controls="collapsePresentations">
                    Paper Presentations
                </button>
            </h2>
