...
class IndexController extends Controller
{
    public function index(Request $request){
        ...
        $accomplishments = EventsAndAccomplishments::whereBetween('created_at', [$startDate, $endDate])->get();

        $pdf = PDF::loadView('admin.reports.accomplishment.accomplishment', compact('accomplishments', 'year', 'quarter', 'half'));
        ...
        $fileName = 'ACCOMPLISHMENTS_AND_EVENTS_' . $request->input('year') . '.pdf';
        ...
        // return $pdf->stream('ACCOMPLISHMENTS_AND_EVENTS.pdf');
    }
}
